...
{
	public class EndlessPinkTorch : ModItem
	{

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Never-Ending Pink Torch");
        }
        ...
        public override void HoldItem(Player player)
        {
            ...
            {
                int index = Dust.NewDust(new Vector2(player.itemLocation.X + 16f * player.direction, player.itemLocation.Y - 20f * player.gravDir), 4, 4, 242, 0.0f, 0.0f, 100, new Color(), 1f);
        ...
        public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.PinkTorch, 198);
